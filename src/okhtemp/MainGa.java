...
public class MainGa {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== OPTIMIZING WITH GENETIC ALGORITHM === \n");
        ...
        switch (input) {
            case 1:
                ...
                GeneticAlgorithm.run(dir_carf92_stu, dir_carf92_crs, 100, iterasi);
            ...
            case 2:
                ...
                GeneticAlgorithm.run(dir_cars91_stu, dir_cars91_crs, 100, iterasi);
            ...
            case 3:
                ...
                GeneticAlgorithm.run(dir_earf83_stu, dir_earf83_crs, 100, iterasi);
            ...
            case 4:
                ...
                GeneticAlgorithm.run(dir_hecs92_stu, dir_hecs92_crs, 100, iterasi);
            ...
            case 5:
                ...
                GeneticAlgorithm.run(dir_kfus93_stu, dir_kfus93_crs, 100, iterasi);
            ...
            case 6:
                ...
                GeneticAlgorithm.run(dir_lsef91_stu, dir_lsef91_crs, 100, iterasi);
            ...
            case 7:
                ...
                GeneticAlgorithm.run(dir_purs93_stu, dir_purs93_crs, 100, iterasi);
            ...
            case 8:
                ...
                GeneticAlgorithm.run(dir_ryes93_stu, dir_ryes93_crs, 100, iterasi);
            ...
            case 9:
                ...
                GeneticAlgorithm.run(dir_staf83_stu, dir_staf83_crs, 100, iterasi);
            ...
            case 10:
                ...
                GeneticAlgorithm.run(dir_tres92_stu, dir_tres92_crs, 100, iterasi);
            ...
            case 11:
                ...
                GeneticAlgorithm.run(dir_utas92_stu, dir_utas92_crs, 100, iterasi);
            ...
            case 12:
                ...
                GeneticAlgorithm.run(dir_utes92_stu, dir_utes92_crs, 100, iterasi);
            ...
            case 13:
                ...
                GeneticAlgorithm.run(dir_yorf83_stu, dir_yorf83_crs, 100, iterasi);
