...
//			execute(dir_carf92_stu, dir_carf92_crs, timeslot);
                long startTime = System.nanoTime();
                Heuristics.hillClimbing(dir_carf92_stu, dir_carf92_crs, timeslot, 1000);
                long endTime = System.nanoTime();
                long totalTime = endTime - startTime;
...
//			execute(dir_cars91_stu, dir_cars91_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_cars91_stu, dir_cars91_crs, timeslot, 1000);
...
//			execute(dir_earf83_stu, dir_earf83_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_earf83_stu, dir_earf83_crs, timeslot, 1000);
...
//			execute(dir_hecs92_stu, dir_hecs92_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_hecs92_stu, dir_hecs92_crs, timeslot, 1000);
...
//			execute(dir_kfus93_stu, dir_kfus93_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_kfus93_stu, dir_kfus93_crs, timeslot, 1000);
...
//			execute(dir_lsef91_stu, dir_lsef91_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_lsef91_stu, dir_lsef91_crs, timeslot, 1000);
...
//			execute(dir_purs93_stu, dir_purs93_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_purs93_stu, dir_purs93_crs, timeslot, 1000000);
...
//			execute(dir_ryes93_stu, dir_ryes93_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_ryes93_stu, dir_ryes93_crs, timeslot, 1000000);
...
//			execute(dir_staf83_stu, dir_staf83_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_staf83_stu, dir_staf83_crs, timeslot, 1000000);
...
//			execute(dir_tres92_stu, dir_tres92_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_tres92_stu, dir_tres92_crs, timeslot, 1000000);
...
//			execute(dir_utas92_stu, dir_utas92_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_utas92_stu, dir_utas92_crs, timeslot, 1000000);
...
//			execute(dir_utes92_stu, dir_utes92_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_utes92_stu, dir_utes92_crs, timeslot, 1000000);
...
//			execute(dir_yorf83_stu, dir_yorf83_crs, timeslot);
                ...
                Heuristics.hillClimbing(dir_yorf83_stu, dir_yorf83_crs, timeslot, 1000000);
